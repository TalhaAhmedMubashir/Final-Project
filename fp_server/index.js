...
process.on(
    'UnhandledRejection', error => {
        ...
        console.log("Countered bug...")
    }
);
app.use('/', authRouter);

app.listen(process.env.PORT || 8080, () => console.log(`Server running on port: http://localhost:${process.env.PORT} DBLINK :${process.env.DBLINK} `))
